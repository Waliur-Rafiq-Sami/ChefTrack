  ...
  return (
    <div className="bg-white rounded-xl shadow hover:shadow-lg transition-all duration-300 overflow-hidden">
      ...
      <div className="p-4">
        ...
        <p className="text-sm text-gray-500 mb-3">{food.foodCategory}</p>
    ...
    <div className="relative bg-white rounded-xl shadow-xl overflow-hidden hover:scale-105 transition-transform duration-300 border border-gray-200">
      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-center mt-3">
          ...
          >
            <span className="material-icons text-sm sm:text-base md:text-lg lg:text-xl">
              Details
            </span>
          </button>
        </div>
