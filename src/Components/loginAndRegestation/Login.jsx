...
const Login = () => {
  ...
  return (
    <div className="flex items-center gap-5 justify-center mt-10 flex-col-reverse md:flex-row my-10 md:my-30">
      ...
      <div className="bg-base-200 xl:w-1/3 lg:w-1/2 w-full p-2">
        <div className="card bg-base-200 w-full shadow-2xl p-5">
          <h3 className="text-3xl font-bold text-center my-3">Login Page</h3>
          <div className="">
            <fieldset className="fieldset">
              ...
              {/* Or, continue with one of the following: */}
              <div className="flex mt-3 gap-2 flex-col md:flex-row  mb-5">
                {/* Google */}
            ...
            <p className="px-1 ">
              ...
              <Link to="/registration">
                <span className="text-orange-400 font-bold ">Registration</span>
              </Link>
            </p>
          </div>
        </div>
